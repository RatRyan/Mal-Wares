        ...
        <div class="card bg-dark text-light m-3">
          ...
          <div class="card-body">
            ...
            <form @submit.prevent="promote" class="d-flex flex-column mb-3">
              <label for="admin-form" class="form-label">Email:</label>
              <input type="email" name="" id="admin-form" class="mb-3 form-control" />
            ...
            <form @submit.prevent="addProduct" class="d-flex flex-column">
              <div class="d-flex flex-column mb-3">
                ...
                <input type="text" name="product-name" id="name" class="form-control" v-model="name"/>
              </div>
              <div class="d-flex flex-column mb-3">
                <label for="description">Description</label>
                <textarea id="description" name="description" rows="4" cols="50" class="form-control" v-model="description"></textarea>
              </div>
              <div class="d-flex flex-column mb-3">
                <label for="image-link">Image Link</label>
                <input type="text" name="image-link" id="image" class="form-control" v-model="image"/>
              </div>
              <div class="d-flex flex-column mb-3">
